...
# Plantillas de noticias para el Mercado de Acciones
# Formato: {símbolo: [lista de (mensaje, multiplicador_precio)]}
# Multiplicador > 1.0 positivo, < 1.0 negativo
...
MARKET_NEWS = {
    ...
    "GENERAL": [
        ("¡El Mercado de Acciones Global entra en un período de crecimiento sin precedentes!", 1.05),
        ("Una repentina recesión económica provoca una caída generalizada del mercado.", 0.95),
        ("Nuevos acuerdos comerciales refuerzan la confianza de los inversores en todos los sectores.", 1.03),
        ("Una crisis logística global ralentiza el comercio internacional.", 0.97),
        ("Los avances tecnológicos impulsan un pequeño auge en el sector tecnológico.", 1.02),
        ("La inestabilidad política en regiones clave genera volatilidad en el mercado.", 0.98),
        ("La bajada de tipos de interés fomenta una mayor inversión.", 1.04),
        ("La quiebra de un gran banco sacude los mercados financieros mundiales.", 0.92),
        ("El desempleo récord mínimo impulsa el gasto del consumidor.", 1.03),
        ("El miedo a una pandemia global provoca un pánico temporal en los mercados.", 0.90),
        ("Los datos de inflación resultan menores de lo esperado, calmando los mercados.", 1.04),
        ("Una crisis geopolítica en una región clave productora de petróleo inquieta a los inversores.", 0.93),
        ("Los bancos centrales señalan que no habrá subidas de tipos durante el próximo año — los mercados celebran la noticia.", 1.05),
        ("Un resultado electoral sorpresa en una economía importante atemoriza a los mercados globales.", 0.94),
        ("Una oleada de compras de inversores minoristas lleva el mercado a nuevos máximos.", 1.06),
    ],
}

# Plantillas genéricas para cualquier empresa que NO esté en MARKET_NEWS. {name} se sustituye.
GENERIC_IPO_NEWS = [
...
def get_random_news(active_symbols=None):
    """
    Obtiene un evento de noticias aleatorio.
    - 70 %: noticias específicas de empresas con entradas dedicadas en MARKET_NEWS
    - 15 %: noticias genéricas aplicadas a un símbolo IPO / desconocido
    - 15 %: noticias generales del mercado (ALL)
    """
